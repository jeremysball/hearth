...
func TestIdentitiesAndPendingTablesExist(t *testing.T) {
	...
	if _, err := db.Exec(`INSERT INTO pending_auth (token_hash, provider, provider_user_id, email, target_family_id, current_family_id, current_caregiver_id, created_at) VALUES (?,'google','sub2','x@y.z','famB','famA','cgA','t')`, hashForTest(t, "tok")); err != nil {
