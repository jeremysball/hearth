...
const REGRESSION_TABLE = [
  { id: '4m',  name: '4-month sleep change', onsetRange: [3.5, 5],   onsetWeeksBefore: 4,
    kicker: 'Regression window',
    mechanism: 'Sleep architecture is shifting into adult-like NREM/REM cycles, so light-sleep transitions can wake babies more often.',
    tonight: 'Keep the bedtime routine steady and expect more help between cycles for a while.',
    sources: 'CHOP; Ednick 2009; Sleep Foundation' },
  { id: '6m',  name: '6-month sleep change', onsetRange: [5.5, 7],   onsetWeeksBefore: 3,
    kicker: 'Regression window',
    mechanism: 'New motor skills, growth, and separation awareness can make settling less predictable.',
    tonight: 'Offer the same calm response each wake so the night stays boring.',
    sources: 'Sleep Foundation; Huckleberry' },
  { id: '810m', name: '8-10-month sleep change', onsetRange: [7.5, 10.5], onsetWeeksBefore: 3,
    kicker: 'Regression window',
    mechanism: 'Crawling, pulling up, object permanence, and separation awareness often overlap with the 3-to-2 nap transition.',
    tonight: 'Practice new skills by day and keep sleep responses simple at night.',
    sources: 'Sleep Foundation; Huckleberry' },
  { id: '12m', name: '12-month sleep change', onsetRange: [11, 13],  onsetWeeksBefore: 3,
    kicker: 'Regression window',
    mechanism: 'Walking practice, separation anxiety, teething, and nap instability can all crowd sleep at this age.',
    tonight: 'Protect naps when you can and use an earlier bedtime after rough nap days.',
    sources: 'Sleep Foundation; Huckleberry' },
  { id: '18m', name: '18-month sleep change', onsetRange: [17, 19],  onsetWeeksBefore: 3,
    kicker: 'Regression window',
    mechanism: 'Language growth, molars, independence, and shifting sleep needs can make bedtime louder for a stretch.',
    tonight: 'Hold the boundary, keep the routine short, and expect bigger feelings.',
...
const STAGE_TIPS = [
  { id: 'newborn-cues', minW: 0, maxW: 6, icon: 'baby', kicker: 'Newborn sleep', title: 'Cues beat schedules',
    body: (n) => `${n} does not have a reliable sleep clock yet. Use yawning, eye-rubs, and looking away as your best signal to settle.`,
    why: 'Before about 6 weeks, sleep is driven mostly by hunger, active sleep, and short newborn cycles.',
    sources: 'CHOP; Ednick 2009' },
  { id: 'day-night-contrast', minW: 0, maxW: 10, icon: 'moon-star', kicker: 'Rhythm cue', title: 'Make days and nights feel different',
    body: (n) => `Keep days bright and social, then make night feeds dim, quiet, and boring. That contrast gives ${n}'s sleep clock a pattern to learn.`,
    why: 'Light-dark contrast and consistent handling are early circadian signals.',
    sources: 'Yates 2018; Kok 2024' },
  { id: 'morning-light-early', minW: 6, maxW: 20, icon: 'sunrise', kicker: 'Rhythm cue', title: 'Morning light helps set the day',
    body: (n) => `Get bright light soon after ${n}'s first wake when you can. Open curtains, step outside, or sit near a bright window.`,
    why: 'Morning light is a strong time-giver for the developing circadian system.',
    sources: 'Yates 2018; Kok 2024' },
  { id: 'night-stretch-protect', minW: 6, maxW: 20, icon: 'moon', kicker: 'Night sleep', title: 'Keep night wakes boring',
    body: (n) => `${n}'s longest sleep stretch may be starting to move into the night. Dim light and quiet feeds help preserve that direction.`,
    why: 'Between 6 and 12 weeks, social cues start to matter and longer night stretches often begin.',
    sources: 'Hearth sleep research synthesis' },
  { id: 'window-position', minW: 10, maxW: 30, icon: 'layers', kicker: 'Wake windows', title: 'The last window runs longer',
    body: () => 'A longer awake stretch before bedtime can be normal. Morning windows tend to be shortest; the last window often carries more sleep pressure.',
    why: 'Wake-window guidance varies by position in the day, not just age.',
    sources: 'Huckleberry; Dubief' },
  { id: 'early-bedtime', minW: 20, maxW: 48, icon: 'moon', kicker: 'Bedtime', title: 'Rough nap day? Move bedtime up',
    body: () => 'When naps run short, an earlier bedtime can protect the night. Overtired babies often take longer to settle, not less.',
    why: 'Sleep pressure helps until it overshoots; then cortisol can make settling harder.',
    sources: 'AASM 2016; Dubief; Weissbluth' },
  { id: 'last-nap-budget', minW: 20, maxW: 48, icon: 'chart-bar', kicker: 'Bedtime', title: 'Late naps spend bedtime budget',
    body: () => 'A late final nap can push bedtime later. If bedtime is sliding, try shortening the last nap or ending it earlier.',
    why: 'Bedtime timing depends on daytime sleep, last nap end, and the final wake window.',
    sources: 'Huckleberry; Hearth sleep research synthesis' },
  { id: 'three-to-two', minW: 28, maxW: 48, icon: 'layers', kicker: 'Nap transition', title: 'Watch for the 3-to-2 shift',
    body: (n) => `If ${n} keeps fighting the third nap or bedtime drifts late, the two-nap rhythm may be getting close. Mixed days are normal during the transition.`,
    why: 'Many babies move toward two naps around 8 to 9 months, with several unstable weeks.',
    sources: 'Staton 2020; Baby Sleep Science' },
  { id: 'two-to-one', minW: 52, maxW: 80, icon: 'layers', kicker: 'Nap transition', title: 'One nap takes time',
    body: () => 'Resisting one nap can mean the one-nap transition is starting. Move gradually and use early bedtime on days the single nap is short.',
    why: 'The 2-to-1 transition often lands between 13 and 18 months and can take weeks.',
    sources: 'Staton 2020; Baby Sleep Science' },
];
