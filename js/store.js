...
const STAGE_TIPS = [
  { id: 'newborn-cues', minW: 0, maxW: 6, icon: 'baby', title: 'Cues beat schedules',
    body: (n) => `${n} doesn't have a reliable sleep clock yet. Hunger and short newborn cycles drive sleep instead. Watch for yawning, eye-rubs, and looking away as the best signal to settle.`,
    sources: 'CHOP; Ednick 2009' },
  ...
  { id: 'morning-light-early', minW: 6, maxW: 20, icon: 'sunrise', title: 'Morning light helps set the day',
    body: (n) => `Get bright light soon after ${n}'s first wake when you can: open curtains, step outside, or sit near a window. It's one of the strongest cues for a developing sleep clock.`,
    sources: 'Yates 2018; Kok 2024' },
  { id: 'night-stretch-protect', minW: 6, maxW: 20, icon: 'moon', title: 'Keep night wakes boring',
    body: (n) => `${n}'s longest sleep stretch is moving into the night. Keep those wakes dim and quiet: the shift firms up faster when nothing exciting happens.`,
  ...
  { id: 'early-bedtime', minW: 20, maxW: 48, icon: 'moon', title: 'Rough nap day? Move bedtime up',
    body: () => 'When naps run short, an earlier bedtime protects the night: overtired babies take longer to settle, not less.',
